...
namespace Example04.WebApplication.Controllers
{
    ...
    public class ContactController : Controller
    {
        ...
        private List<Menu> GetSubMenus()
        {
            ...
            Menu menu1 = new Menu() { Id = 1, DisplayName = "Bize ulasın", Controller = "Contact", Action = "BizeUlasin" };
            Menu menu2 = new Menu() { Id = 2, DisplayName = "Şikayet Öneri", Controller = "Contact", Action = "SikayetOneri" };
            Menu menu3 = new Menu() { Id = 3, DisplayName = "İş başvurusu", Controller = "Contact", Action = "İsBasvurusu" };
