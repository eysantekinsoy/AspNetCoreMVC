...
namespace Example05.WebApplication.Services
{
    public class StudentService
    {
        ...
        public static List<Student> Students()
        {
            ...
            students.Add(new Student() { Id = 4, Name = "Ender", Surname = "Tekinsoy", Email = "endertekinsoy@hotmail.com", BirthDate = new DateOnly(1962, 10, 02), Gender = Gender.Male, StudentStatus = StudentStatus.Frezee });
